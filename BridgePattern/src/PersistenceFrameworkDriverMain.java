...
public class PersistenceFrameworkDriverMain {
...
public static void main(String[] args) {
		...
		/*IPersistence persistenceAPI = new PersistenceImpAbstract(implementor);
		...
		persistenceAPI = new PersistenceImpAbstract(implementor); 
